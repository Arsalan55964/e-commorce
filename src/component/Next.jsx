...
const products = [
 ...
 image1: "Frame 39.svg",
     ...
     price: "$145", image: "one.png" },
  { id: 2, name: "Polo with Tipping Details",image1: "Frame 39.svg",
     price: "$180", image: "two.png" },
  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-6 mt-[3rem]">
     ...
     <h2 className="text-lg font-semibold  ml-[2rem] font-bold">{product.name}</h2>
          ...
          <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mt-[0.5rem] ml-[2rem]">Add to Cart</button>
        </div>
      ))}
    </div>
    {/* commits */}
